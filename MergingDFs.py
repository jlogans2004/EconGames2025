...
def find_parking_type(row):
    if row["Type"] == "Monthly":
        ...
        return "Transient"
    elif not isinstance(row["TicketType"], float) and "Short" in row["TicketType"]:
        return "Transient"
...
entry_exit_amano.rename(columns={"Activity Date" : "Time", "Payment Type": "parking_type", "Direction" : "Entry_dummy"})
